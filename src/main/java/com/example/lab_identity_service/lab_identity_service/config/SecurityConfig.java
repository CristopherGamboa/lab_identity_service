package com.example.lab_identity_service.lab_identity_service.config;
...
import com.example.lab_identity_service.lab_identity_service.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Permitir acceso sin autenticación al endpoint de registro (opcional)
